...
export const manageSiteLocation = async (requestObj = {}, token) => {
  let url = Configs.USER_MGMT_BASE + "manage_site_location/";
  let requestOptions = {
    method: "POST",
...
export const getSiteLocation = async (cid,dept, token) => {
  let url = getRequestUrl(Configs.USER_MGMT_BASE + "get_site_Location", { cid });
