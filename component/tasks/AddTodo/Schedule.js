...
import { translations } from "../../../screen/Settings/LanguageSettigs/localizations";
...
class Schedule extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      schedule: [
        { text: i18n.t("once"), value: "one" },
        { text: i18n.t("daily"), value: "daily" },
        { text: i18n.t("weekly"), value: "weekly" },
        { text: i18n.t("monthly"), value: "monthly" },
      ],
  ...
  return (
    <View style={styles.wrapper}>
      <View style={{ alignItems: "center" }}>
        <Text style={{ color: Colors.textColor }}>{i18n.t("starts_on")}</Text>
        <TouchableOpacity
          onPress={() => {
            showDatePicker("date");
          }}
      ...
      <View style={{ alignItems: "center" }}>
        <Text style={{ color: Colors.textColor }}>{i18n.t("end_by")}</Text>
        <TouchableOpacity
          onPress={() => {
            showDatePicker("time");
          }}
