...
export default class PurchaseOrderDetails extends React.Component {
	...
	render = () => {
		return (
			<Container>
				<Header title={i18n.t("request_details")} />
						...
						<ScrollView showsVerticalScrollIndicator={false}>
							<View style={styles.itemInfoContainer}>
								<View style={{ flexDirection: "row", marginBottom: 10 }}>
									<View style={{ flex: 1 }}>
										<Text style={styles.subText}>{i18n.t("request_no")}</Text>
										<Text style={styles.titleText}>
											{"#" + this.state.poNo}
										</Text>
									</View>
									<View style={{ flex: 1 }}>
										<Text style={styles.subText}>{i18n.t("date")}</Text>
										<Text style={styles.titleText}>
							...
							<View style={styles.theadRow}>
								<View style={{ flex: 1 }}>
									<Text style={styles.titleText}>{i18n.t("name")}</Text>
								</View>
								<View style={{ flex: 0.5, alignItems: "flex-end" }}>
									<Text style={styles.titleText}>{i18n.t("price")}</Text>
								</View>
								<View style={{ flex: 0.5, alignItems: "center" }}>
									<Text style={styles.titleText}>{i18n.t("quantity")}</Text>
								</View>
								<View style={{ flex: 0.5, alignItems: "flex-end" }}>
							...
							>
								<View style={{ flex: 1 }}>
									<Text style={styles.titleText}>{i18n.t("total")}</Text>
								</View>
							...
							{!this.state.isConverted && this.state.approveClicked === 0 ? (
								...
								>
									<Text style={styles.textWhite}>{i18n.t("`")}</Text>
								</TouchableOpacity>
