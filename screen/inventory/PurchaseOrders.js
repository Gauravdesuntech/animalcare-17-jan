		...
		>
			<View style={styles.row}>
				<View style={styles.leftPart}>
					<Text style={styles.name}>{i18n.t("request_by") + item.user_name}</Text>
					<Text style={styles.name}>{i18n.t("department") + item.dept_name}</Text>
					<Text style={styles.subText}>
						{i18n.t("date") + moment(item.date, "YYYY-MM-DD").format("DD/MM/YYYY")}
					</Text>
					{/* <Text style={styles.subText}>{"Party: " + item.party_name}</Text> */}
					<Text style={styles.subText}>{i18n.t("amount") + item.amount}</Text>
				</View>
