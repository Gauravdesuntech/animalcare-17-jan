	...
	renderListItem = ({ item }) => (
		<TouchableHighlight underlayColor={"#eee"}>
			<View style={styles.row}>
				<View style={styles.leftPart}>
					<Text style={styles.name}>{item.name}</Text>
					<Text style={styles.subText}>{i18n.t("type") + item.type}</Text>
					<Text style={styles.subText}>
						{i18n.t("current_stock") + item.total_stock + " " + item.unit}
					</Text>
					<Text style={styles.subText}>
						{i18n.t("reorder_level") + item.reorder_level + " " + item.unit}
					</Text>
				</View>
				<View style={styles.rightPart}>
					{/* <View style={styles.rightPartStock}>
					...
					<TouchableOpacity style={styles.rightPartButton}
						onPress={this.getRequestDetails.bind(this, item)}
					>
						<Text style={styles.rightPartButtonText}>{i18n.t("add_request")}</Text>
					</TouchableOpacity>
				</View> : null }
				</View>
			</View>
	...
	render = () => (
		<Container>
			...
			>
				<View style={styles.centeredView}>
					<View style={styles.modalView}>
						<Text style={styles.modalText}>{i18n.t("hi_this_product_is_already_requested")}</Text>
						...
						<Text style={styles.modalText}>{i18n.t("do_you_want_to_order")}</Text>
						<View>
							<TouchableOpacity
								onPress={() => {
									this.setModalVisible(!this.state.modalVisible)
			...
			>
				<View style={styles.centeredView}>
					<View style={styles.modalView}>
						<Text style={styles.modalText}>{i18n.t("do_you_want_to_change_order_quantity")}</Text>
						<View>
							<TouchableOpacity
								onPress={() => {
							...
							>
								<Text style={styles.btnText}>{i18n.t("order_without_changing_quantity")}</Text>
							</TouchableOpacity>
							<TouchableOpacity
								onPress={() => {
									this.showOrderEdit();
							...
							>
								<Text style={styles.btnText}>{i18n.t("change_quantity")}</Text>
							</TouchableOpacity>
						</View>
					</View>
				</View>
			...
			>
				<View style={styles.centeredView}>
					<View style={styles.modalView}>
						<Text style={styles.modalText}>{i18n.t("you_have_already_requested")}</Text>
						{this.state.prevRequestData.length > 0 ?
							this.state.prevRequestData.map((item) => {
								return (
									<View style={styles.detailsContainer}>
						...
						<Text style={styles.modalText}>{i18n.t("do_you_want_to_change_quantity")}</Text>
						<View>
							<TouchableOpacity
								onPress={() => {
									this.setReorderWarning(!this.state.reOrderWarning)
