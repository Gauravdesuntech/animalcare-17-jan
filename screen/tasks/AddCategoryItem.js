...
class AddCategoryItem extends React.Component {
      ...
      editTask(task_id)
        .then((response) => {
          ...
          this.setState({
            ...
            selectedCategory_name: data.category_name,
  ...
  onAssignChange = (value) => {
    if (value) {
      ...
      alert(i18n.t("select_atleast_one_user"));
    }
    ...
    this.setState(
      ...
      () => {
        ...
        if (obj.name == "" || obj.name == undefined) {
          ...
          alert(i18n.t("choose_assign_person"));
          this.setState({ loading: false });
          return;
        } else if (
          obj.approval == true &&
          ...
          alert(i18n.t("choose_approval_user"));
          this.setState({ loading: false });
          return;
        } else if (
          obj.task_related_to == "" ||
          ...
          alert(i18n.t("choose_task_related_to"));
          this.setState({ loading: false });
          return;
        } else if (obj.priority == "" || obj.priority == undefined) {
          alert(i18n.t("choose_priority"));
          this.setState({ loading: false });
          return;
        }
        ...
        // }
          ...
          alert(i18n.t("choose_photo_proof"));
          this.setState({ loading: false });
          return;
        } else {
          ...
          if (this.state.editable) {
            ...
            msg = i18n.t("update_suc_done");
          } else {
            task = addTask(obj);
            msg = i18n.t("add_suc_done");
          }
          task
            .then((response) => {
              const sources = response.data;
        ...
        <View style={styles.body}>
          ...
          >
            ...
            >
              {this.state.loading === true ? (
                ...
                >
                  <Text style={styles.btns}>
                    {this.state.editable ? i18n.t("update") : i18n.t("save")}{" "}
                  </Text>
                </TouchableOpacity>
              )}
              ...
              >
                <Text style={styles.btns}>{i18n.t("exit")} </Text>
              </TouchableOpacity>
            </View>
