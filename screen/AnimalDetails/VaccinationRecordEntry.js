      ...
      <View style={styles.container}>
        ...
        >
          <View style={styles.formBorder}>
            ...
            <View style={[styles.fieldBox]}>
              <Text style={styles.labelName}>{i18n.t("next_date")}</Text>
              <TouchableOpacity
                activeOpacity={1}
                style={[
                  { flexDirection: "row", alignItems: "center", width: "50%" },
            ...
            >
              <Text style={styles.labelName}>{i18n.t("dosage_unit")}</Text>
              <TextInput
            ...
            >
              <Text style={styles.labelName}>{i18n.t("lot")}#:</Text>
              <TextInput
            ...
            /> */}
            <View style={[styles.fieldBox]}>
              <Text style={styles.labelName}>{i18n.t("expiry_date")}:</Text>
              <TouchableOpacity
                activeOpacity={1}
                style={[
                  { flexDirection: "row", alignItems: "center", width: "50%" },
            ...
            >
              <Text style={styles.labelName}>{i18n.t("batch_number")}:</Text>
              <TextInput
            ...
            >
              <Text style={styles.labelName}>{i18n.t("note")}:</Text>
              <TextInput
