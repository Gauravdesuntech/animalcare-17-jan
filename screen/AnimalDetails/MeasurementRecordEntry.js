  ...
  render = () => (
    <Container>
      <Header
        ...
        title={i18n.t("measurement_record_entry")}
        leftIconShow={true}
        rightIconShow={false}
      ...
      <View style={styles.container}>
        <ScrollView ref={this.scrollViewRef}>
          <View style={styles.formBorder}>
            ...
            >
              <Text style={styles.labelName}>{i18n.t("weight")}</Text>
              <TextInput
            ...
            >
              <Text style={styles.labelName}>{i18n.t("height")}</Text>
              <TextInput
            ...
            >
              <Text style={styles.labelName}>{i18n.t("len")}</Text>
              <TextInput
            ...
            >
              <Text style={styles.labelName}>{i18n.t("width")}</Text>
              <TextInput
            ...
            >
              <Text style={styles.labelName}>{i18n.t("performer")}</Text>
              <TextInput
