...
export default class Profile_Pedigree extends React.Component {
  ...
  chooseIcon = () => {
    ImagePicker.requestMediaLibraryPermissionsAsync().then((status) => {
      if (status.granted) {
        ...
        Alert.alert(i18n.t("choose_icon_allow"));
      }
    });
  };
    ...
    uploadAnimalImages(data)
      .then((res) => {
        ...
        if (res.check == "success") {
          ...
          this.setState({ imageLoader: false, showLoader: false });
          alert(i18n.t("reupload_last_image"));
        }
      })
      .catch((err) => {
        console.log(err);
      ...
      .then((response) => {
        ...
        let msg =
          parseInt(this.state.id) > 0
            ? i18n.t("profile_updated_successfully")
            : i18n.t("profile_created_successfully");
        this.setState(
          {
            showLoader: false,
          },
  ...
  render = () => (
    <>
      ...
      >
        <Text style={[styles.step_nav, styles.activeText]}>{i18n.t("1")}</Text>
        ...
        {this.state.currentstep == 2 || this.state.currentstep == 3 ? (
          <Text style={[styles.activeText, styles.step_nav]}>
            {i18n.t("2")}
          </Text>
        ) : (
          <Text style={[styles.activeText, styles.inactive_step_nav]}>
            {i18n.t("2")}
          </Text>
        )}
          ...
          {this.state.currentstep == "1" ? (
            <>
              <View style={styles.formBorder}>
                ...
                <InputDropdown
                  label={i18n.t("identification_type")}
                  isMandatory={true}
                ...
                <InputDropdown
                  ...
                  textFieldStyle={[
                    styles.textfield,
                    this.state.source ? styles.width50 : null,
                  ]}
                  style={[
                    styles.fieldBox,
                ...
                {this.state.source === "In House Breading" ? (
                  <>
                    ...
                    >
                      <Text style={styles.labelName}>{i18n.t("father")}</Text>
                      <TextInput
                        editable={false}
                    ...
                    >
                      <Text style={styles.labelName}>{i18n.t("mother")}</Text>
                      <TextInput
                        editable={false}
                ...
                <View style={[styles.fieldBox]}>
                  <Text style={styles.labelName}>{i18n.t("source_date")} </Text>
                  <TouchableOpacity
                    activeOpacity={1}
                    style={[
                      {
              ...
              /> */}
                ...
                <View style={[styles.fieldBox]}>
                  <Text style={styles.labelName}>{i18n.t("date_birth")}</Text>
                  <TouchableOpacity
                    activeOpacity={1}
                    style={{
                      flexDirection: "row",
              ...
              /> */}
                ...
                <View style={[styles.fieldBox]}>
                  <Text style={styles.labelName}>{i18n.t("approx_dob")}</Text>
                  <TouchableOpacity
                    activeOpacity={1}
                    style={{
                      flexDirection: "row",
              ...
              /> */}
                ...
                <View style={styles.fieldBox}>
                  <Text style={styles.labelName}>{i18n.t("approx_age")}</Text>
                  <TextInput
                ...
                <View style={[styles.fieldBox, { borderBottomWidth: 0 }]}>
                  <Text style={styles.labelName}>{i18n.t("age")}</Text>
                  <TextInput
                ...
                {typeof this.state.parentEnclosureIDName !== "undefined" ? (
                  ...
                  >
                    <TextInput
                      autoCompleteType="off"
                      autoCapitalize="none"
                      placeholder={i18n.t("type_animal_code")}
