...
export default class BriefView extends React.Component {
  ...
  handleSubmit = () => {
    Alert.alert(i18n.t("warning"), i18n.t("hide_record"), [
      { text: i18n.t("yes"), onPress: () => this.manageStatus() },
      { text: i18n.t("no") },
    ]);
  };
  ...
  manageStatus = () => {
    ...
    manage_animal_active_status(obj)
      .then((res) => {
        Alert.alert(i18n.t("success"), i18n.t("animal") + res.message, [
  ...
  render = () => (
    <Container style={globalStyles.container}>
      <ScrollView ref={this.scrollViewRef} showsVerticalScrollIndicator={false}>
        <View style={globalStyles.form}>
          <View style={globalStyles.rowContainer}>
            ...
            this.state.identificationType === "DNA-Microchip-Ring Number" ? (
              <View style={[globalStyles.row]}>
                <View style={globalStyles.rowLeft}>
                  <Text style={[globalStyles.labelName]}>{i18n.t("dna")}</Text>
                </View>
                <View style={globalStyles.rowRight}>
                  <Text style={globalStyles.textfield}>
                    {this.state?.dna ? this.state?.dna : i18n.t("na")}
                  </Text>
                </View>
              </View>
            ) : null}
            ...
            <View style={[globalStyles.row]}>
              <View style={globalStyles.rowLeft}>
                <Text style={[globalStyles.labelName]}>{i18n.t("sex")}</Text>
              </View>
              <View style={globalStyles.rowRight}>
                <Text style={globalStyles.textfield}>
                  {this.state?.sex ? this.state?.sex : i18n.t("na")}
                </Text>
              </View>
            </View>
            <View style={[globalStyles.row]}>
            ...
            <View style={[globalStyles.row]}>
              <View style={globalStyles.rowLeft}>
                <Text style={[globalStyles.labelName]}> {i18n.t("color")}</Text>
              </View>
              <View style={globalStyles.rowRight}>
                <Text style={globalStyles.textfield}>
                  {this.state?.color ? this.state?.color : i18n.t("na")}
                </Text>
              </View>
            </View>
            <View style={[globalStyles.row]}>
              <View style={globalStyles.rowLeft}>
                <Text style={[globalStyles.labelName]}>{i18n.t("father")}</Text>
              </View>
              <View style={globalStyles.rowRight}>
                <Text style={globalStyles.textfield}>
                  {this.state?.father ? this.state?.father : i18n.t("na")}
                </Text>
              </View>
            </View>
            <View style={[globalStyles.row, globalStyles.bbw0]}>
              <View style={globalStyles.rowLeft}>
                <Text style={[globalStyles.labelName]}>{i18n.t("mother")}</Text>
              </View>
              <View style={globalStyles.rowRight}>
                <Text style={globalStyles.textfield}>
                  {this.state?.mother ? this.state?.mother : i18n.t("na")}
                </Text>
              </View>
            </View>
          </View>
        ...
        <TouchableOpacity
          style={[globalStyles.incidentbtnCover, { margin: 10, width: 100 }]}
          onPress={this.handleSubmit}
        >
          <Text style={globalStyles.incidentbtns}>{i18n.t("hide")}</Text>
        </TouchableOpacity>
        ...
        <View style={[globalStyles.form, { marginBottom: 10, height: 160 }]}>
          <View>
            <Text style={globalStyles.textSub}>{i18n.t("animal_photos")}</Text>
          </View>
          <ScrollView
            horizontal={true}
