		...
		<TouchableHighlight underlayColor={"#eee"}>
			<View style={globalStyles.row}>
				<View style={globalStyles.leftPart}>
					...
					<Text style={[globalStyles.textfield,globalStyles.no_bg_color,globalStyles.pd0]}>
					{i18n.t("animal_id") + item.animal_id }
					</Text>
					<Text style={[globalStyles.textfield,globalStyles.no_bg_color,globalStyles.pd0]}>
					{i18n.t("date") + getFormattedDate(convertDate(item.animal_dead_date),'DD/MM/YYYY') }
					</Text>
					<Text style={[globalStyles.textfield,globalStyles.no_bg_color,globalStyles.pd0]}>
						{i18n.t("reason") + item.animal_dead_reason}
					</Text>
					{/* <Text style={globalStyles.subText}>
						{"Reorder Level: " + item.reorder_level + " " + item.unit}
					</Text> */}
			...
			>
				<View style={globalStyles.container}>
					<View style={globalStyles.modalBody}>
						...
						>
							<Text style={globalStyles.closeBtnText}>{i18n.t("close")}</Text>
						</TouchableOpacity>
					</View>
				</View>
			</Modal>
