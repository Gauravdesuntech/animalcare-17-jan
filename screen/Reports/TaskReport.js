...
import { InputDropdown, ListEmpty, Loader, MultiSelectDropdown } from "../../component";
...
<html lang="en">
  ...
  filterQuery = (value) => {
    ...
    if (value.id == i18n.t("custom")) {
      this.setState({ showDate: true, fromDate: date, activeTab: { ...value } })
    } else {
      value.id == i18n.t("last_7_day") ? date = substractDays(7) : value.id == i18n.t("yesterday") ? date = substractDays(1) : date;
