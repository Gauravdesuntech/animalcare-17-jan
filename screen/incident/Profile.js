  ...
  render = () => (
    <ScrollView ref={this.scrollViewRef}>
      <View style={styles.container}>
        ...
        >
          <Text style={styles.labelName}>{i18n.t("animal_id")} :</Text>
          <TextInput
        ...
        >
          <Text style={styles.labelName}>{i18n.t("incident_type")} :</Text>
          <TextInput
        ...
        >
          <Text style={styles.labelName}>{i18n.t("priority")} :</Text>
          <TextInput
            editable={false}
        ...
        >
          <Text style={styles.labelName}>{i18n.t("reported_by")} :</Text>
          <TextInput
        ...
        >
          <Text style={styles.labelName}>{i18n.t("solution")} :</Text>
          <TextInput
        ...
        >
          <Text style={styles.labelName}>{i18n.t("to_be_closed_by")} :</Text>
          <TextInput
        ...
        <View
          style={[
            styles.fieldBox,
            this.state.currentStatusValidationFailed
              ? styles.errorFieldBox
              : null,
          ]}
        >
          <Text style={styles.labelName}>{i18n.t("current_status")} :</Text>
          <TextInput
