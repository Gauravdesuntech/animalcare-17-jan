        ...
        <ScrollView ref={this.formScrollViewRef}>
          <View style={globalStyles.boxBorder}>
            <View style={[globalStyles.fieldBox]}>
              <Text style={globalStyles.labelName}>{i18n.t("title")}</Text>
              <TextInput
              ...
              {this.state.hasIncidentTypeNameValidationError ? (
                <Text style={globalStyles.errorText}>{i18n.t("enter_title")}</Text>
              ) : null}
            </View>

            <View style={[globalStyles.fieldBox]}>
              <Text style={globalStyles.labelName}>{i18n.t("description")}</Text>
              <TextInput
                multiline={true}
                // numberOfLines={10}
            ...
            <View style={[globalStyles.fieldBox, globalStyles.bbw0]}>
              <Text style={globalStyles.labelName}>{i18n.t("image")}</Text>
            </View>
            <Upload
              uploadable={true}
              type={"image"}
            ...
            />
            <View style={[globalStyles.fieldBox]}>
              <Text style={globalStyles.labelName}>{i18n.t("duration")}</Text>
          ...
          <View style={globalStyles.buttonsContainer}>
            <TouchableOpacity activeOpacity={1} onPress={this.addAnnouncement}>
              <Text style={[globalStyles.buttonText, globalStyles.saveBtnText]}>{i18n.t("save")}</Text>
            </TouchableOpacity>

            <TouchableOpacity activeOpacity={1} onPress={this.gotoBack}>
              <Text style={[globalStyles.buttonText, globalStyles.exitBtnText]}>{i18n.t("next")}</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
