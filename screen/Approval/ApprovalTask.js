        ...
        return (
            <SafeAreaView style={[globalStyles.container, { padding: 0 }]}>
                <Header
                    navigation={this.props.navigation}
                    leftNavTo={'Home'}
                    title={this.state.activeTabKey == 'task' ? i18n.t("task_approval") :  i18n.t("enclosure_approval")}
                />
                        ...
                        <View style={globalStyles.body}>
                            {
                                this.state.data.length > 0 ?
                                    ...
                                    <View style={{ alignItems: 'center', marginTop: 20 }}>
                                        <Text style={{ color: Colors.danger }}> {i18n.t("no_approval_task_available")}</Text>
                                    </View>
                            }
                        </View>
                        :
                        ...
                        <View style={globalStyles.body}>
                            {
                                this.state.enclosureData.length > 0 ?
                                    ...
                                    :
                                    <View style={{ alignItems: 'center', marginTop: 20 }}>
                                        <Text style={{ color: Colors.danger }}>{i18n.t("no_enclosure_available")}</Text>
                                    </View>
                            }
                        </View>
                    }
                        ...
                        >
                            <View style={globalStyles.centeredView}>
                                <View style={globalStyles.modalView}>
                                    <View>
                                        <Text>{i18n.t("reject_reason")}</Text>
                                    </View>
                                    <TextInput
                                        ...
                                        placeholder={i18n.t("enter_reject_reason")}
                                    ...
                                    >
                                        ...
                                        >
                                            <Text style={globalStyles.btnText}>{i18n.t("cancel")}</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity
                                            onPress={this.rejectRequest}
                                            style={[globalStyles.btn, globalStyles.btnSuccess]}
                                        >
                                            <Text style={globalStyles.btnText}>{i18n.t("reject")}</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
                            </View>
