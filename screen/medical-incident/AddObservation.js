  ...
  */}
      ...
      >
        <View style={[globalStyles.popupContainer, globalStyles.mt60]}>
          <Text style={globalStyles.popupText}>{i18n.t("assign_type")} :</Text>
          ...
          <View style={[globalStyles.flexDirectionRow, globalStyles.mt40]}>
            <View style={globalStyles.btnContainer}>
              ...
              >
                <Text style={globalStyles.textWhite}>{i18n.t("save")}</Text>
              </Pressable>
            </View>
            ...
            <View style={globalStyles.btnContainer}>
              ...
              >
                <Text style={globalStyles.textWhite}>{i18n.t("cancel")}</Text>
              </Pressable>
            </View>
          </View>
        </View>
        ...
        <View style={[globalStyles.popupContainer, globalStyles.mt60]}>
          ...
          <View style={[globalStyles.flexDirectionRow, globalStyles.mt40]}>
            <View style={globalStyles.btnContainer}>
              ...
              >
                <Text style={globalStyles.textWhite}>{i18n.t("yes")}</Text>
              </Pressable>
            </View>
            ...
            <View style={globalStyles.btnContainer}>
              ...
              >
                <Text style={globalStyles.textWhite}>{i18n.t("no")}</Text>
              </Pressable>
            </View>
          </View>
        </View>
