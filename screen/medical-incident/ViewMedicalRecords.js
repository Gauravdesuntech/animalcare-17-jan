...
export default class ViewMedicalRecord extends React.Component {
  ...
  handleSubmit = () => {
    Alert.alert(
      `${i18n.t("warning")}!!`,
      `${i18n.t("do_you_want_to_hide_this_record")}`,
      [
  ...
  manageStatus = () => {
    ...
    manage_active_status(obj)
      .then((res) => {
        Alert.alert(i18n.t("success"), i18n.t("medical_report") + res.message, [
  ...
  render = () => {
    console.log(JSON.parse(this.props.route.params.item.image));
    return (
      <Container>
        <Header
          title={i18n.t("view_medical_record")}
        ...
        >
          ...
          {this.props.route.params.item.image ? (
            <>
              ...
              >
                <View>
                  <Text style={globalStyles.textSub}>
                    {i18n.t("attachments")}
                  </Text>
                </View>
                <ScrollView
