...
export default class LocationRange extends React.Component {
  ...
  render = () => (
    <Container>
      <Header title={i18n.t("change_range")} />
        ...
        >
          <View style={styles.boxBorder}>
            ...
            <View style={[styles.fieldBox, { borderBottomWidth: 0 }]}>
              <Text style={styles.labelName}>{i18n.t("range")}: </Text>
              <TextInput
          ...
          <TouchableOpacity
            style={[styles.button, { marginHorizontal: 80 }]}
            onPress={this.saveRange}
          >
            <Text style={styles.textWhite}>{i18n.t("submit")}</Text>
          </TouchableOpacity>
        </KeyboardAwareScrollView>
      </View>
