      ...
      <Header
        title={
          parseInt(this.state.id) > 0
            ? i18n.t("edit_medical_record")
            : i18n.t("add_medical_record")
        }
        ...
        >
          ...
          <View style={styles.boxBorder}>
            ...
            */}
            ...
            {/* <View style={[styles.inputContainer, styles.pb0, styles.mb0]}> */}
            <View style={[styles.fieldBox]}>
              <Text style={styles.labelName}>{i18n.t("upload_photos")}</Text>
              <TouchableOpacity
                activeOpacity={1}
