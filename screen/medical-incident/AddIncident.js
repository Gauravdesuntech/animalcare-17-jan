...
export default class AddIncident extends React.Component {
        ...
        () => {
          ...
          addIncident(obj, this.state.incidentUploadData)
            ...
            .catch((error) => {
              ...
              alert(i18n.t("something_went_wrong_try_again"));
              console.log(error);
            });
        }
      );
  ...
  chooseIncidentPhotos = () => {
    ImagePicker.requestMediaLibraryPermissionsAsync().then((status) => {
      if (status.granted) {
        ...
        Alert.alert(i18n.t("please_allow_permission_to_choose_images"));
      }
    });
  };
    ...
    Camera.requestCameraPermissionsAsync()
      .then((result) => {
        if (result.status === "granted") {
          ...
          Alert.alert(i18n.t("please_give_the_permission"));
        }
      })
      .catch((error) => console.log(error));
  };
  ...
  handleBarCodeScanned = (data) => {
    try {
      ...
      console.log(error);
      this.setState({ isScanModal: !this.state.isScanModal });
      alert(i18n.t("wrong_qr_code_scan"));
    }
  };
      ...
      <Header
        title={
          parseInt(this.state.id) > 0
            ? i18n.t("edit_incident")
            : i18n.t("report_incident")
        }
  ...
  */}
            <>
              ...
              <View style={[styles.fieldBox, { borderBottomWidth: 0 }]}>
                <Text style={styles.labelName}>{i18n.t("attach_photos")}</Text>
      ...
      >
        <View style={[styles.popupContainer, { marginTop: "60%" }]}>
          <Text style={styles.popupText}>{i18n.t("assign_type")} :</Text>
          <View style={{ padding: 10 }}>
            ...
            {this.state.hasAssignTypeError ? (
              <Text style={{ color: Colors.danger }}>
                {i18n.t("please_choose_any_assign_type")}
              </Text>
            ) : null}
          </View>
          ...
          {this.state.notification_type == "Departments" ? (
            <View style={{ padding: 10 }}>
              <InputDropdown
                ...
                label={i18n.t("choose_department")}
          ...
          <View style={{ flexDirection: "row", marginTop: 40 }}>
            ...
            <View style={{ width: "50%", paddingLeft: 20, paddingRight: 20 }}>
              ...
              >
                <Text style={styles.textWhite}>{i18n.t("cancel")}</Text>
              </Pressable>
            </View>
          </View>
        </View>
      ...
      >
        <View style={[styles.popupContainer, { marginTop: "60%" }]}>
          <Text style={styles.popupText}>{i18n.t("do_you_want_to_save")}</Text>
          <View style={{ flexDirection: "row", marginTop: 40 }}>
            <View style={{ width: "50%", paddingLeft: 20, paddingRight: 20 }}>
              <Pressable
                style={styles.button}
              ...
              >
                <Text style={styles.textWhite}>{i18n.t("yes")}</Text>
              </Pressable>
            </View>
            ...
            <View style={{ width: "50%", paddingLeft: 20, paddingRight: 20 }}>
              ...
              >
                <Text style={styles.textWhite}>{i18n.t("no")}</Text>
              </Pressable>
            </View>
          </View>
        </View>
      ...
      >
        <View style={[styles.popupContainer, { marginTop: "60%" }]}>
          <Text style={styles.popupText}>
            {i18n.t("do_you_want_to_save_and_notify")}
          </Text>
          <View style={{ flexDirection: "row", marginTop: 40 }}>
            <View style={{ width: "50%", paddingLeft: 20, paddingRight: 20 }}>
              <Pressable
      ...
      >
        <View style={[styles.popupContainer, { marginTop: "60%" }]}>
          <Text style={styles.popupText}>{i18n.t("save_and_create_task")}</Text>
          <View style={{ padding: 10 }}>
            <InputDropdown
